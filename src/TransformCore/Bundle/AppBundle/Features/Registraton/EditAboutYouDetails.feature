Feature: As an user, I want to be able to add details about myself on my account, in order to apply for jobs
  ...
  Scenario: Complete About You Section (Happy path)
    ...
    # Date of Birth
    And I fill in "date-of-birth" with "08/02/1968"
    # Phone details
    ...
    # Date of birth
    And the "date-of-birth" field should contain "08/02/1968"
    # Address details
  ...
  Scenario: Complete About You Section (Field validation)
    ...
    And I fill in "date-of-birth" with "c/b/d"
    ...
    Then I should see "Date of birth in wrong format"
  ...
  Scenario: Complete About You Section (Mandatory fields)
    ...
    Then I should see "Please enter address (at least first line, town, postcode and country)"
