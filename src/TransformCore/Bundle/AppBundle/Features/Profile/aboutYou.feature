...
#    And I should see "Please enter mobile number for sms alerts"
  ...
  Scenario: Password reset in About You Section
    ...
    And I am on "/en/logout"
    Then I am logged in as "one@test.com" with password "P@ssword2"
    And I follow "Profile"
    And I fill in "csr_dm_user_profile_plainPassword_first" with "P@ssword1"
    And I fill in "csr_dm_user_profile_plainPassword_second" with "P@ssword1"
    Then I press "Save and Continue"
    And I am on "/en/logout"
