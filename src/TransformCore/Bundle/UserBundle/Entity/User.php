...
namespace TransformCore\Bundle\UserBundle\Entity;
 ...
 * Class User
 *
 * This would be part of the Domain Model
 *
 * @package TransformCore\Bundle\UserBundle\Entity
 */
class User implements UserInterface
{
    ...
    {
        return ($this->locked === true)? false : true;
    }
